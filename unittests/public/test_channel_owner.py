...
class TestChannelOwner(TestChannel):
    @patch('source.public.channel.owner.exit.exit', autospec=True)
    ...
    @patch('source.public.channel.owner.channel.say', autospec=True)
    ...
    @patch('source.public.channel.owner.channel.join', autospec=True)
    ...
    @patch('source.public.channel.owner.channel.part', autospec=True)
    ...
    @patch('source.public.channel.owner.channel.empty_all', autospec=True)
    ...
    @patch('source.public.channel.owner.channel.empty', autospec=True)
    ...
    @patch('source.public.channel.owner.managebot.manage_bot', autospec=True)
