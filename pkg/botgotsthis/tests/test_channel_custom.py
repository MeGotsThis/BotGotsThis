...
class TestChannelCustomCustomCommand(TestChannel):
    def setUp(self):
        ...
        patcher = patch('pkg.botgotsthis.library.custom.get_command')
        self.addCleanup(patcher.stop)
        self.mock_command = patcher.start()
        self.mock_command.return_value = self.command

        patcher = patch('pkg.botgotsthis.library.custom.create_messages')
        self.addCleanup(patcher.stop)
    ...
    async def test(self):
        self.assertIs(await custom.customCommands(self.args), True)
        self.mock_command.assert_called_once_with(
            self.database, 'kappa', 'botgotsthis', self.permissions)
...
class TestChannelCustomCommand(TestChannel):
    def setUp(self):
        ...
        patcher = patch('pkg.botgotsthis.channel.custom.process_command')
        self.addCleanup(patcher.stop)
    ...
    async def test_command(self):
        ...
        self.assertIs(await custom.commandCommand(self.args), True)
        self.mock_process.assert_called_once_with(self.args, 'botgotsthis')

    async def test_global(self):
        self.assertIs(await custom.commandGlobal(self.args), False)
        self.assertFalse(self.mock_process.called)
        self.permissions.inOwnerChannel = True
        self.permissionSet['admin'] = True
        self.mock_process.return_value = True
        self.assertIs(await custom.commandGlobal(self.args), True)
...
class TestChannelCustomProcessCommand(TestChannel):
    def setUp(self):
        ...
        patcher = patch('pkg.botgotsthis.library.custom.parse_action_message',
                        autospec=True)
        self.addCleanup(patcher.stop)
    ...
    async def test(self):
        self.assertIs(
            await custom.process_command(self.args, self.broadcaster), False)
    ...
    async def test_level_access(self):
        ...
        self.assertIs(
            await custom.process_command(self.args, self.broadcaster), True)
        self.mock_input.assert_called_once_with(self.message, self.broadcaster)
        self.channel.send.assert_called_once_with(
    ...
    @patch('pkg.botgotsthis.channel.custom.insert_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.update_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.replace_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.append_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.delete_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.command_property')
    ...
    @patch('pkg.botgotsthis.channel.custom.raw_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.level_command')
    ...
    @patch('pkg.botgotsthis.channel.custom.rename_command')
    ...
    async def test_insert_command(self):
        ...
        self.assertIs(await custom.insert_command(self.args, input), True)
    ...
    async def test_update_command(self):
        ...
        self.assertIs(await custom.update_command(self.args, input), True)
    ...
    async def test_append_command(self):
        ...
        self.assertIs(await custom.append_command(self.args, input), True)
    ...
    async def test_replace_command(self):
        ...
        self.assertIs(await custom.replace_command(self.args, input), True)
    ...
    async def test_delete_command(self):
        ...
        self.assertIs(await custom.delete_command(self.args, input), True)
    ...
    async def test_command_property_false(self):
        ...
        self.assertIs(await custom.command_property(self.args, input), False)
    ...
    async def test_command_property_empty(self, mock_list):
        ...
        self.permissionSet['broadcaster'] = True
        self.assertIs(await custom.command_property(self.args, input), True)
        self.assertFalse(self.database.processCustomCommandProperty.called)
        self.channel.send.assert_called_once_with(
    ...
    async def test_raw_command(self, mock_whisper, mock_config):
        ...
        self.assertIs(await custom.raw_command(self.args, input), True)
    ...
    async def test_level_command(self):
        ...
        self.assertIs(await custom.level_command(self.args, input), True)
    ...
    async def test_rename_command(self):
        ...
        self.assertIs(await custom.rename_command(self.args, input), True)
