...
class TestChannelCustomProcessCommand(TestChannel):
    ...
    @patch('source.public.channel.custom.insert_command')
    ...
    @patch('source.public.channel.custom.update_command')
    ...
    @patch('source.public.channel.custom.replace_command')
    ...
    @patch('source.public.channel.custom.append_command')
    ...
    @patch('source.public.channel.custom.delete_command')
    ...
    @patch('source.public.channel.custom.raw_command')
    ...
    @patch('source.public.channel.custom.level_command')
    ...
    @patch('source.public.channel.custom.rename_command')
